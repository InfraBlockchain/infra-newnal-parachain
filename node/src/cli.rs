...
const AFTER_HELP_EXAMPLE: &str = color_print::cstr!(
   ...
   <bold>infra-newnal-parachain --chain urauth-infra --sync warp -- --chain infra-relay-local --sync warp</>
           Launch a warp-syncing full node of the <italic>Asset Hub</> parachain on the <italic>InfraBlockchain</> Relay Chain.
   <bold>infra-newnal-parachain --chain urauth-infra --sync warp --relay-chain-rpc-url ws://rpc.example.com -- --chain infra-relay-local</>
           Launch a warp-syncing full node of the <italic>Asset Hub</> parachain on the <italic>InfraBlockchain</> Relay Chain.
